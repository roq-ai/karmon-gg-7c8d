...
import { createDiscord } from 'apiSdk/discords';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl id="discord_info" mb="4" isInvalid={!!formik.errors?.discord_info}>
            ...
            <Input type="text" name="discord_info" value={formik.values?.discord_info} onChange={formik.handleChange} />
